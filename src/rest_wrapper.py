...
from utils import timer, yaml_load
...
class ApiHandler:
    ...
    def add_news_to_history(self):
        ...
        with timer(f"add news to index"):
    ...
    def run(self):
        ...
        self.app.add_url_rule(
            "/add_news", view_func=self.add_news_to_history, methods=["POST"]
        )
        self.app.add_url_rule(
            "/append_history", view_func=self.append_to_history, methods=["POST"]
        )
