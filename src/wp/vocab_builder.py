...
class VocabBuilder():
    ...
    def __init__(self, path, model_prefix='tokenizer', voc_size = 3200,
                    num_placeholders = 256, subsample_size = 12800000, voc_fname = "vocab.txt"):
        self.path = path
